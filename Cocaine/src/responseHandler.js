...
var ResponseHandler = cc.Layer.extend({
    ctor : function(x,y,w) {
        ...
        this.templateLabel = new cc.LabelTTF("Required Input: GDAGDAFHdahyrdjyutdbfGTTEJAYRAFEWhtejeGRhtejyrgrwRFREFD", "Arial", 12, cc.size(10, 56), cc.TEXT_ALIGNMENT_LEFT);
        this.templateLabel.setFontFillColor(new cc.color(127,127,127,255));
        this.templateLabel.x = x+8;
        ...
        this.inputField = new cc.TextFieldTTF("Entered Input: GRAGRTWERYTUGFTRERTYUYTREWQERTYUYTREWQWERTYUIYTREWI", cc.size(10, 56), cc.TEXT_ALIGNMENT_LEFT, "Arial", 12);
        this.inputField.setFontFillColor(new cc.color(0,0,255,255));
        this.inputField.x = x+8;
        this.inputField.y = y;
